    ...
    const fetchSeguros = async () => {
      ...
      try {
        ...
        const segurosMapeados = arrSeguros.map((seg, idx) => ({
          ...
          TipoVigencia: seg.TipoVigencia ?? seg.tipoVigencia,
          VigenciaTemporal: seg.VigenciaTemporal ?? seg.vigenciaTemporal,
          FechaVigencia: seg.FechaVigencia ?? seg.fechaVigencia,
        }));
