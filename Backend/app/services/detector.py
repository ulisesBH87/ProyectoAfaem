...
def modelo_segmentacion():
    ...
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    # Construir ruta al modelo
    segmentacion_model_path = os.path.join(BASE_DIR, "..", "models", "selfie_multiclass_256x256.tflite")
    # Normalizar la ruta
...
def modelo_segmentacion_deeplab():
    ...
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    # Construir ruta al modelo
    segmentacion_model_path = os.path.join(BASE_DIR, "..", "models", "deeplab_v3.tflite")
    # Normalizar la ruta
    segmentacion_model_path = os.path.abspath(segmentacion_model_path)
    return segmentacion_model_path 
